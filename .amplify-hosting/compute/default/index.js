...
import { RemixServer, Form, useActionData, Link, useLocation, Meta, Links, Outlet, ScrollRestoration, Scripts, useParams, useNavigate } from "@remix-run/react";
...
const InnerPageBackgroundImage = "/assets/pageBackground-C3WoatTl.jpg";
...
function HeaderComponent$1() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "header", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "header__navigations", children: navLinks$1.map(
        (item, index) => item.isModal ? /* @__PURE__ */ jsx(
          "button",
          {
            onClick: () => handleModalOpen(item.methodType),
            className: "header__navigations--items " + (item.isBtnStyle ? "header__navigations--items-button" : ""),
            children: /* @__PURE__ */ jsx("span", { className: "header__navigations--items_text", children: item.label })
          },
          index
        ) : /* @__PURE__ */ jsx(
          Link,
    ...
    /* @__PURE__ */ jsx("div", { className: `modal-overlay ${showModal ? "show" : ""}`, children: /* @__PURE__ */ jsx(PopupModal, { onClose: handleModalClose, children: /* @__PURE__ */ jsxs(Fragment, { children: [
...
function HeaderComponent() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "header inner-header", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "header__navigations", children: navLinks.map(
        (item, index) => item.isModal ? /* @__PURE__ */ jsx(
          "button",
          {
            onClick: () => handleModalOpen(item.methodType),
...
const Layout = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "layout", children }),
    /* @__PURE__ */ jsx(Footer, {})
  ] });
};
const links = () => [
...
function SearchResult() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "search-results", children: /* @__PURE__ */ jsxs("h2", { children: [
    "Results for ",
    slug.replace(/-/g, " ")
  ] }) });
}
...
const SearchBannerForm = ({ suggestions: suggestions2 }) => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "search", children: /* @__PURE__ */ jsxs("div", { className: "search__auto--complete", children: [
    ...
    visible && /* @__PURE__ */ jsx("div", { className: "search__suggestions", children: /* @__PURE__ */ jsx("ul", { className: "search__suggestions--list", children: suggestions2.filter((i) => i.toLowerCase().includes(search.toLowerCase())).map((i, v) => /* @__PURE__ */ jsx(
      "li",
      {
...
const serverManifest = { "entry": { "module": "/assets/entry.client-DeA8rHLL.js", "imports": ["/assets/index-18G_WLPD.js", "/assets/components-CrjxfCYs.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/root-5197wbqO.js", "imports": ["/assets/index-18G_WLPD.js", "/assets/components-CrjxfCYs.js", "/assets/icons-BpHDlEWU.js"], "css": ["/assets/root-w9Eah9hT.css"] }, "routes/search.$slug": { "id": "routes/search.$slug", "parentId": "root", "path": "search/:slug", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/search._slug-CWGN0Bg3.js", "imports": ["/assets/index-18G_WLPD.js"], "css": [] }, "routes/_index": { "id": "routes/_index", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/_index-CW-xsqgy.js", "imports": ["/assets/index-18G_WLPD.js", "/assets/icons-BpHDlEWU.js"], "css": ["/assets/_index-BN07op5p.css"] }, "routes/signin": { "id": "routes/signin", "parentId": "root", "path": "signin", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/signin-l0sNRNKZ.js", "imports": [], "css": [] } }, "url": "/assets/manifest-3a63dc18.js", "version": "3a63dc18" };
