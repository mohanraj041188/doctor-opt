  ...
  return (
    <section className="search">
      <div className="search__auto--complete">
        <div className={"search__input " + (animateSearch ? 'search__input--focused' : '')}>
          ...
          <input
            ...
            onBlur={typingHide}
          />
          <div className={"search__input--suggestionanimte " + (hideTyping ? 'search__input--focused' : '')}>
            <Typewriter cursor="|" texts={searchSuggestText} delay={100} infinite={true} />
          </div>
