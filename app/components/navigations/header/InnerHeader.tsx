      ...
      <div className="header inner-header">
        ...
        <div className="header__center-center">
          <ul className="nav-link_list">
            <li>
              <div>
                <Link className="nav-link_list-item" to="/">Find Doctors</Link>
              </div>
            </li>
            <li>
              <div>
                <Link className="nav-link_list-item" to="/">Video Consult</Link>
              </div>
            </li>
            <li>
              <div>
                <Link className="nav-link_list-item" to="/">Surgeries</Link>
              </div>
            </li>
          </ul>
        </div>
          ...
          {navLinks.map((item, index) => (
            item.isModal ? (
              <button
                ...
                key={index}
              >
                <span className="header__navigations--items_text">{item.label}</span>
              </button>
            ) : (
              <Link
                to={item.link}
          ...
          <>
            <div className='popup-modal__body'>
              ...
              <p className='popup-modal__body--description'>
                {showSignup ? (
                  ...
                  <>
                    Input your email to receive a one-time login code to sign in.
                  </>
                )}
              </p>
            ...
            <div className='popup-modal__footer'>
              <p className='popup-modal__footer--text'>
                {showSignup ? (
                  <>
                    Already have an account? <button onClick={() => handleSignup(!showSignup)}>Sign In</button>
                  </>
                ) : (
                  <>
